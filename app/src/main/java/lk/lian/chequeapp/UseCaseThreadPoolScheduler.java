...
public class UseCaseThreadPoolScheduler implements UseCaseScheduler {
  ...
  @Override public <T extends UseCase.ResponseValue> void notifyResponse(final T response,
  ...
  @Override
  public <T extends UseCase.ResponseValue> void onError(final UseCase.UseCaseCallback<T> callback) {
    mHandler.post(new Runnable() {
      @Override public void run() {
        callback.onError();
      }
